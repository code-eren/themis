...
(async () => {
  ...
  let tx = await cf.createCampaign(oracleAddr, gameId, teamId0, teamId1, odds0, odds1);
  console.log(tx);
  ...
  await sendToken("0xa36085F69e2889c224210F603D836748e7dC0088", "3.0", 18, newAddress, "kovan");
