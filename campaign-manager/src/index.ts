...
const cors = [
  ...
  (_: any) => header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept"),
  (_: any) => header("Access-Control-Allow-Methods", "GET, PUT, PATCH, POST, DELETE, HEAD"),
